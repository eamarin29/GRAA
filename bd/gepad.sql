...
-- Volcando datos para la tabla gepad.actividad: ~5 rows (aproximadamente)
DELETE FROM `actividad`;
/*!40000 ALTER TABLE `actividad` DISABLE KEYS */;
INSERT INTO `actividad` (`codigoactividad`, `fechaactividad`, `horadesdeactividad`, `horahastaactividad`, `descripcionactividad`, `resultadosobtenidosactividad`, `codigomonitoractividad`, `cantidadhorasactividad`, `codigoinformeactividad`) VALUES
	(1, '2016-03-24', '5:00pm', '6:00om', 'exvcelente', 'ninguno', 1, 1, 1),
	(2, '2016-03-25', '4', '5', 'dd', 'jj', 1, 2, 1),
	(6, '2016-03-23', '88', '99', 'kjk', 'kjk', 1, 8, 1),
	(7, '2016-04-07', '2', 'hkh', 'hkjhjk', 'kjhk', 1, 7, 1),
	(8, '2016-03-09', 'kln', 'jkl', 'jlk', 'jl', 1, 4, 1);
...
DELETE FROM `ambientedeaprendizaje`;
...
INSERT INTO `ambientedeaprendizaje` (`codigoambiente`, `nombreambiente`, `capacidadambiente`, `areaambiente`, `codigotipoambiente`, `numerosedeambiente`, `estadoambiente`) VALUES
	(1, 'Sala sistemas', 40, 80, 1, 3, 'Disponible'),
	(2, 'Mercadeo', 50, 80, 1, 3, 'Disponible'),
	(3, 'Cabras\r\n', 30, 76, 1, 3, 'Disponible');
...
INSERT INTO `aprendiz` (`documentoaprendiz`, `fichatitulacionaprendiz`) VALUES
	(31755103, 1),
	(38874052, 1);
...
-- Volcando datos para la tabla gepad.area: ~1 rows (aproximadamente)
DELETE FROM `area`;
...
-- Volcando datos para la tabla gepad.centro: ~1 rows (aproximadamente)
DELETE FROM `centro`;
...
-- Volcando datos para la tabla gepad.dependencia: ~1 rows (aproximadamente)
...
DELETE FROM `elementoparticular`;
...
DELETE FROM `evaluacionaprendiz`;
...
DELETE FROM `evaluacioncoordinador`;
...
-- Volcando datos para la tabla gepad.experiencia: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla gepad.informe: ~1 rows (aproximadamente)
DELETE FROM `informe`;
/*!40000 ALTER TABLE `informe` DISABLE KEYS */;
INSERT INTO `informe` (`codigoinforme`, `fechainforme`, `periodoinforme`, `codigomonitor`, `balanceinforme`, `sugerenciasinforme`, `archivoevidencias`, `estadoinforme`, `observacionesinforme`) VALUES
	(1, '2016-03-24', '2', 1, 'balanceado', 'N/A', _binary 0x320000, 'excelente', 'ninguna');
...
-- Volcando datos para la tabla gepad.monitor: ~1 rows (aproximadamente)
DELETE FROM `monitor`;
/*!40000 ALTER TABLE `monitor` DISABLE KEYS */;
INSERT INTO `monitor` (`codigomonitor`, `documentoaprendiz`, `codigotipomonitoria`, `documentopersonal`, `fechainiciomonitoria`, `fechafinmonitoria`, `proyectomonitor`, `estadomonitoria`, `numerocuentamonitor`) VALUES
	(1, 31755103, 1, 31657622, '2016-03-24', '2016-03-25', 'Granja', 'Excelente', 111111);
...
-- Volcando estructura para tabla gepad.participante
CREATE TABLE IF NOT EXISTS `participante` (
  `documentoparticipante` bigint(20) NOT NULL,
  `sloganparticipante` varchar(100) DEFAULT NULL,
  `logoparticipante` varchar(100) DEFAULT NULL,
  `nombreeventoparticipante` varchar(100) DEFAULT NULL,
  `votosparticipante` int(11) DEFAULT NULL,
  `estadopropuestaparticipante` varchar(100) DEFAULT NULL,
  `fichaparticipante` int(11) DEFAULT NULL,
  PRIMARY KEY (`documentoparticipante`),
  KEY `FK_participante_fichatitulacion` (`fichaparticipante`),
  CONSTRAINT `FK_participante_fichatitulacion` FOREIGN KEY (`fichaparticipante`) REFERENCES `fichatitulacion` (`fichatitulacion`),
  CONSTRAINT `FK_participante_personal` FOREIGN KEY (`documentoparticipante`) REFERENCES `personal` (`documentopersonal`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gepad.participante: ~2 rows (aproximadamente)
DELETE FROM `participante`;
/*!40000 ALTER TABLE `participante` DISABLE KEYS */;
INSERT INTO `participante` (`documentoparticipante`, `sloganparticipante`, `logoparticipante`, `nombreeventoparticipante`, `votosparticipante`, `estadopropuestaparticipante`, `fichaparticipante`) VALUES
	(38874052, 'jkjhjk', 'hjkhjkh', 'jkhjkhjkh', 12, 'popopo', 756676),
	(43508604, 'kljuiuuijhkjhjkh', 'uiuoiu', 'uoiuu', 0, 'POSTULADO', 756676);
...
-- Volcando datos para la tabla gepad.personal: ~199 rows (aproximadamente)
...
INSERT INTO `personal` (`documentopersonal`, `nombrepersonal`, `apellidopersonal`, `direccionpersonal`, `correopersonal`, `telefonopersonal`, `clavepersonal`, `fechanacimientopersonal`, `lugarnacimientopersonal`, `fotopersonal`) VALUES
	(1, 'q', 'q', 'q', 'q', 'q', 'q', '2016-03-01', 'q', NULL),
...
-- Volcando datos para la tabla gepad.reservaambiente: ~7 rows (aproximadamente)
...
INSERT INTO `reservaambiente` (`codigoreservambiente`, `codigoambiente`, `documentopersonal`, `fichatitulacion`, `fechainicioreserva`, `fechafinreserva`, `horainicioreserva`, `horafinreserva`) VALUES
	(1, 2, 1, 1, '2016-04-20', '2016-04-28', '06:00:00', '14:00:00'),
	(2, 3, 2631490, 1, '2016-04-18', '2016-04-20', '06:00:00', '17:00:00'),
	(3, 1, 2631490, 1, '2020-02-11', '2020-05-19', '08:00:00', '19:00:00'),
	(4, 2, 1467461, 1, '2014-02-22', '2015-02-22', '06:00:00', '18:00:00'),
	(5, 2, 16280474, 1, '2016-04-15', '2016-04-17', '10:50:00', '12:50:00'),
	(6, 1, 2631490, 1, '2020-05-30', '2020-05-30', '06:00:00', '22:00:00'),
	(7, 2, 1467461, 1, '2016-04-15', '2016-04-22', '12:00:00', '18:00:00');
...
INSERT INTO `sede` (`numerosede`, `nombresede`, `direccionsede`, `documentofuncionario`, `estadosede`) VALUES
	...
	(2, 'CLEM', 'Km2 Tulua-Buga', 16345190, 'Disponible'),
	(3, 'Salesiano', 'Calle 26 No 22-22', 16345190, 'Disponible');
...
-- Volcando datos para la tabla gepad.tipoambiente: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla gepad.tipomonitoria: ~1 rows (aproximadamente)
DELETE FROM `tipomonitoria`;
/*!40000 ALTER TABLE `tipomonitoria` DISABLE KEYS */;
INSERT INTO `tipomonitoria` (`codigotipomonitoria`, `nombretipomonitoria`, `descripciontipomonitoria`) VALUES
	(1, 'N/A', 'N/A');
